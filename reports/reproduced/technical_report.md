...
Each bracketed interval is a clip-bootstrap 95% interval. Metric-specific `*_n`, `*_n_missing`, finite/infinite counts, and all attempted/successful/failed counts are available in [summary_results.csv](../../outputs/reproduced_summary/summary_results.csv).
...
![Detection rates](../../outputs/reproduced_summary/figures/detection_rates.png)

![Message recovery](../../outputs/reproduced_summary/figures/message_recovery.png)

![Score distributions](../../outputs/reproduced_summary/figures/score_distributions.png)
...
![Quality and detection](../../outputs/reproduced_summary/figures/quality_vs_detection.png)

There were 0 failed inference/attack rows. [failures.csv](../../outputs/reproduced_summary/failures.csv) retains every failed row and its error message, including an empty header-only file if none failed. Setup, download, test, and other command failures are recorded in `STATUS.md` and `outputs/logs/`; absence of failed inference rows does not imply that every setup command succeeded. See those records for exact commands and resolutions.
...
- Dataset composition: [dataset_composition.csv](../../outputs/reproduced_summary/dataset_composition.csv); paired contrasts: [paired_differences.csv](../../outputs/reproduced_summary/paired_differences.csv); aggregation metadata: [aggregation_metadata.json](../../outputs/reproduced_summary/aggregation_metadata.json).
...
| Claims audit | status=passed | [claims_audit.json](../../outputs/claims_audit.json) |
