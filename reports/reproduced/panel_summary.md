...
**Evidence.** [Technical report](technical_report.md), [raw-derived summary](../../outputs/reproduced_summary/summary_results.csv), [failures](../../outputs/reproduced_summary/failures.csv), and [source notes](source_notes.md).
